    ...
    namespace opengl {
        ...
        void VertexArrayObject::build(scene::Scene* scene)
        {
            ...
            for (int object_index = 0; object_index < num_objects; object_index++) {
                ...
                glNamedBufferData(_vbo_vertex_normal_vectors[object_index], 3 * num_faces * sizeof(glm::vec3f), object->_face_normal_vectors.get(), GL_STATIC_DRAW);
                ...
                glNamedBufferData(_vbo_vertex_colors[object_index], 3 * num_faces * sizeof(glm::vec3f), object->_face_normal_vectors.get(), GL_STATIC_DRAW);
                ...
                glVertexArrayVertexBuffer(vao, 3, _vbo_vertex_colors[object_index], 0, sizeof(glm::vec3f));
